...
*/
-- DropForeignKey
ALTER TABLE "BlogMaster" DROP CONSTRAINT "BlogMaster_composedById_fkey";

-- AlterTable
ALTER TABLE "BlogDetails" ADD COLUMN     "sortingNo" INTEGER NOT NULL DEFAULT 0;

-- AlterTable
ALTER TABLE "BlogMaster" ALTER COLUMN "composedById" SET DATA TYPE TEXT;
